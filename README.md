...
```javascript
import idamax from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-idamax@v0.0.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-base-idamax/actions/workflows/test.yml/badge.svg?branch=v0.0.1
[test-url]: https://github.com/stdlib-js/blas-base-idamax/actions/workflows/test.yml?query=branch:v0.0.1
